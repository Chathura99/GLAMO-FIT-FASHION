...
<body>
    ...
    <!-- Contact Start -->
    <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3"> Hey! Beautiful Refer to our FAQs to find out answers for your questions. Send us an Email at the following email addresses for more clarifications.</span></h2>
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                <div class="bg-light p-30 mb-30">
                    ...
                    <div class="bg-light p-30 mb-3">
                        ...
                        <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>077-0052775</p>
                </div>
            </div>
        </div>
    </div>
