            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            <td class="align-middle"><img src="img/pr 1.jpg" alt="" style="width: 50px;"> PRINTED MINI DRESS</td>
                            <td class="align-middle">LKR 1990</td>
                        ...
                        <tr>
                            <td class="align-middle"><img src="img/pr8.jpg" alt="" style="width: 50px;"> LIGHT GREEN LEHENGA</td>
                            <td class="align-middle">LKR 5600</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                                        <button class="btn btn-sm btn-primary btn-minus" >
                        ...
                        <tr>
                            <td class="align-middle"><img src="img/MD1.jpg" alt="" style="width: 50px;">COLOURFULL MAXI DRESS </td>
                            <td class="align-middle">LKR 2000</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                                        <button class="btn btn-sm btn-primary btn-minus" >
                        ...
                        <tr>
                            <td class="align-middle"><img src="img/Tr.jpg" alt="" style="width: 50px;">BROWN TROUSER</td>
                        ...
                        <tr>
                            <td class="align-middle"><img src="img/KD.jpg" alt="" style="width: 50px;"> BABY PINK FROCK</td>
                        ...
                        <tr>
                            <td class="align-middle"><img src="img/bs7.jpg" alt="" style="width: 50px;"> COOL CUTR DRESS</td>
                            <td class="align-middle">LKR 800</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                                        <button class="btn btn-sm btn-primary btn-minus" >
