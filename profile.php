...
if (isset($_SESSION['name'])) {
    ...
    <head>
        ...
        <!-- Google Web Fonts -->
        <link rel="preconnect" href="https://fonts.gstatic.com">align
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row px-xl-5">
                <div class="col-lg-8">
                    <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">User Profile</span></h5>
